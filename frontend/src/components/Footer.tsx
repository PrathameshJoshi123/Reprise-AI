          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400">
              ...
              <p className="flex items-center">
                ...
                <a href="mailto:support@cashnow.co.in" className="hover:text-primary transition-colors">
              ...
              <p className="flex items-center">
                ...
                <a href="tel:7378339989" className="hover:text-primary transition-colors">
                  7378339989
                </a>
              </p>
            </div>
