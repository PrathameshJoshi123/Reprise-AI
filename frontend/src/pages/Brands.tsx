...
const BRANDS = [
  ...
  { id: "nokia", name: "Nokia", logo: "/assets/brands/nokia.png", devices: 16 },
  {
    id: "motorola",
    name: "Motorola",
    logo: "/assets/brands/motorola.png",
    devices: 22,
  },
  {
    id: "huawei",
...
const BRAND_PHONES = {
  apple: [
    ...
    },
    {
      id: "iphone-12-pro",
      name: "iPhone 12 Pro",
      image: "/assets/phones/iphone-12-pro.png",
      maxPrice: 35000,
    },
    {
      id: "iphone-12",
    ...
    },
    {
      id: "iphone-11-pro",
      name: "iPhone 11 Pro",
      image: "/assets/phones/iphone-11-pro.png",
      maxPrice: 28000,
    },
    {
      id: "iphone-11",
  ...
  samsung: [
    ...
    },
    {
      id: "samsung-s21-plus",
      name: "Galaxy S21+",
      image: "/assets/phones/samsung-s21-plus.png",
      maxPrice: 35000,
    },
    {
      id: "samsung-s21",
      name: "Galaxy S21",
      image: "/assets/phones/samsung-s21-base.png",
      maxPrice: 30000,
    },
    {
      id: "samsung-note-20",
      name: "Galaxy Note 20",
      image: "/assets/phones/samsung-note-20.png",
      maxPrice: 32000,
    },
    {
      id: "samsung-s20",
      name: "Galaxy S20",
      image: "/assets/phones/samsung-s20.png",
      maxPrice: 25000,
    },
  ],
};
...
export default function Brands() {
              ...
              <div className="flex items-center mt-4">
                <div className="w-16 h-16 bg-white rounded-full p-2 flex items-center justify-center mr-4 shadow-sm">
                  <img
                    src={
                      brand?.logo ||
                      `https://placehold.co/100x100?text=${brand?.name}`
                    }
                    alt={brand?.name}
                        ...
                        <div className="flex flex-col items-center">
                          <div className="w-24 h-24 flex items-center justify-center mb-3">
                            <img
                              src={
                                phone.image ||
                                `https://placehold.co/240x240?text=${phone.name}`
                              }
                              alt={phone.name}
                              className="max-h-full max-w-full object-contain"
                              onError={(e) => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow bg-gray-50 py-8">
        <div className="container mx-auto px-4">
          {/* 'Browse by Brand' heading removed per request */}
