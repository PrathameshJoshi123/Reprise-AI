...
export default function Checkout() {
  ...
  const { isLoggedIn, session, isLoading, user } = useAuth();
  ...
  useEffect(() => {
    ...
    if (user?.pincode) {
      setForm(prev => ({ ...prev, pincode: user.pincode || prev.pincode }));
    }
              ...
              <div className="relative flex items-center justify-between">
                ...
                {stepIcons.map((stepItem, index) => (
                  ...
                  >
                    ...
                    <p
                      className={`text-sm mt-3 font-medium transition-colors ${step >= index + 1 ? "text-gray-900" : "text-gray-400"
                        }`}
                    >
                      {stepItem.label}
                    </p>
                  ...
                  <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={`border-2 rounded-xl p-4 transition-all cursor-pointer ${paymentMethod === "wallet"
                            ? "border-blue-500 bg-blue-50/50 shadow-md"
                            : "border-gray-200 hover:border-gray-300"
                            }`}
                        >
