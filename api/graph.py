...
def calculate_node(state: PricingState) -> dict:
    price = state.get("base_price") # Now passed from outside
...
# Removed "Retrieve Base Price" node
graph.add_node("Calculate Price", calculate_node)

graph.add_edge(START, "Calculate Price")
...
if __name__ == "__main__":
    ...
    inputs_1 = {
        ...
        "base_price": 100000.0, # Manually pass base price for test
        "final_price": None,
        "log": []
    }
    ...
    inputs_2 = {
        ...
        "has_bill": True,
        "is_under_warranty": False,
        "base_price": 50000.0, # Manually pass base price for test
        "final_price": None,
        "log": []
    }
